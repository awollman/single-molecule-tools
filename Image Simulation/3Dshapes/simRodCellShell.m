function projection_image=simRodCellShell(radius, lengthVar, width,realCenter, orientation,psf,sizeImage)

Center=[sizeImage(2)/2,sizeImage(1)/2];
projection_imageCylinder=simCylinderShell(radius, lengthVar,width, Center, psf,sizeImage);
Center1=Center;
Center1(2)=Center(2)-lengthVar;
projection_imageSphere1=simHalfSphereShell(radius, Center,width, psf, size(projection_imageCylinder));
